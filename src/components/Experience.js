...
import PairAnythingLogo from '../images/PairAnythingLogo.jpg';
import ObjectSecurityLogo from '../images/ObjectSecurityLogo.png';
  ...
  return (
    <div name="experience">
      ...
      <animated.div key={index} style={props} className="experience-card">
        <img src={experience.logo} alt={experience.title + " logo"} className="experience-logo"/>
